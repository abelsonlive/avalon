...
AUDIO_EXTENSIONS: Final[set[str]] = {".mp3", ".flac", ".aiff", ".aif", ".m4a", ".mp4", ".wav"}
...
TAG_FRAME_MAPS: Final[dict[FileFormat, TagFrameMap]] = {
    FileFormat.MP3: TagFrameMap(
        ...
        track_number="TRCK", date="TDRC", genre="TCON", bpm="TBPM", key="TKEY",
        headline="COMM", extended="TXXX:" + EXTENDED_TAG_NAME,
    ),
    ...
    FileFormat.FLAC: TagFrameMap(
        ...
        track_number="TRACKNUMBER", date="DATE", genre="GENRE", bpm="BPM", key="INITIALKEY",
        headline="DESCRIPTION", extended=EXTENDED_TAG_NAME,
    ),
    FileFormat.MP4: TagFrameMap(
        title="\xa9nam", artist="\xa9ART", album="\xa9alb", album_artist="aART",
        track_number="trkn", date="\xa9day", genre="\xa9gen", bpm="tmpo", key=MP4_KEY_ATOM,
        headline="desc", extended=MP4_EXTENDED_ATOM,
    ),
}
